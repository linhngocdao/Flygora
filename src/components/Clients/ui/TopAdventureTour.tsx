...
const TopAdventureTour = () => {
  ...
  const images = [
    {id: '1', alt: 'Image 1', src: 'https://images.unsplash.com/photo-1551632811-561732d1e306?w=800&h=600&fit=crop'},
    {id: '2', alt: 'Image 2', src: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=600&fit=crop'},
    {id: '3', alt: 'Image 3', src: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800&h=600&fit=crop'},
    {id: '4', alt: 'Image 4', src: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=600&fit=crop'},
    {id: '5', alt: 'Image 5', src: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800&h=600&fit=crop'},
    {id: '6', alt: 'Image 6', src: 'https://images.unsplash.com/photo-1551632811-561732d1e306?w=800&h=600&fit=crop'},
    {id: '7', alt: 'Image 7', src: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=600&fit=crop'},
  ];
              ...
              <div className="xl:w-[568px] lg:w-1/2 space-y-4 lg:pl-4 xl:pl-0 lg:pb-[300px]">
                ...
                <div className="space-y-4">
                  ...
                  <div className="text-gray-700 body-1 line-clamp-2">
                    <p>The 05-day, 04-night journey to conquer Kong collapse will take you on an adventurous and
                      challenging
                      expedition. This is one of the most exciting adventure tours in Vietnam, with the highlight being
                      the
                      thrilling experience of rappel down a 100-meter deep sinkhole. In addition, you will swim and
                      explore the
                ...
                <div className="lg:w-1/2 pb-[37px] space-x-8 flex items-center xl:pl-8 max-lg:hidden">
                  ...
                  <div className="flex space-x-2">
                    <button onClick={prevSlide} className="btn-slider selectNavPrev swiper-button-disabled">
                      <Image
                    ...
                    <button onClick={nextSlide} className="btn-slider selectNavNext rounded-full p-5 bg-amber-200">
                      <Image
                          src="/images/homePage/pre.svg"
                          alt="arrow left"
