            ...
            <section>
                <div className="bg-[url('/images/homePage/main-bg.webp')] bg-cover">
                    ...
                    >
                        ...
                        >
                            <div className="absolute top-[37px] left-0 w-3/4 rounded-lg overflow-hidden">
                                <div className="aspect-w-1 aspect-h-1">
                                    <img alt="jungle boss travelodge"
                            ...
                            <div className="absolute top-0 right-0 w-1/2 overflow-hidden rounded-lg">
                                <div className="aspect-w-6 aspect-h-7">
                                    <img alt="a wonderful stopover when visiting phong nha ke bang"
                        ...
                        <div className="space-y-4"><h2 className="pre-header text-[#ede52a]">Jungle
                            Boss Travelodge</h2>
                            <div className="space-y-2"><h3
                                className="text-white uppercase lg:whitespace-pre-line max-md:hidden  text-[1.5rem] font-[600] leading-[125%] lg:text-[2rem]">
                                A wonderful stopover when visiting Phong Nha - Ke Bang</h3>
                                <div
                                    className="text-white uppercase md:hidden title-dropline  text-[1.5rem] font-[600] leading-[125%] lg:text-[2rem]">A
                                    wonderful
                                    stopover when visiting Phong Nha - Ke Bang
                                </div>
                            </div>
                            <div className="text-[#e0e0e0] leading-[155%] text-[0.8rem] lg:text-[1rem] experience"><p
                                style={{textAlign: 'justify'}}>Nestled amidst the
                                immense rice fields of the Phong Nha - Ke Bang region, Jungle Boss Travelodge is an
                                ideal place for
                                you to unwind during your Quang Binh travels. This destination offers cozy
                                accommodations with a
                                full range of amenities, including aswimming pool, bar, BBQ area, high-speed Wi-Fi, and
                                complimentary bicycles. Come here to experience peaceful, dreamy moments in the land of
                                heritage.</p></div>
                            <div className="relative items-center space-x-2 max-md:justify-center xl:space-x-4">
                                <ButtonSecondary name="Explore" size="md" variant="outline"/>
                            </div>
                        </div>
                    </div>
                </div>
