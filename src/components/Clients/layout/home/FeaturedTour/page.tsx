            ...
            <div className="xl:w-[568px] lg:w-1/2 space-y-4 lg:pl-4 xl:pl-0 lg:pb-[300px]">
              ...
              <div className="space-y-4">
                ...
                <div className="text-gray-700 body-1 line-clamp-2">
                  <p>
                    ...
                    adventure tours in Vietnam, with the highlight being the thrilling experience of
                    rappel down a 100-meter deep sinkhole. In addition, you will swim and explore
                    the Tiger cave, admire the magnificent beauty of the stalactite formations in
                    Hang Over cave, and camp overnight in Pygmy cave – the 4th largest cave in the
                    world.
                  </p>
                </div>
              ...
              <div className="lg:w-1/2 pb-[37px] space-x-8 flex items-center xl:pl-8 max-lg:hidden">
                ...
                <div className="flex space-x-2">
                  ...
                  >
                    <Image src="/images/homePage/pre.svg" alt="arrow left" width={17} height={10} />
                  </button>
                  <button
                    onClick={nextSlide}
