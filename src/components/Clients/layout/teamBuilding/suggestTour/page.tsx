...
const SuggestTour = () => {
  return (
    <section className="xl:py-[68px] md:py-[48px] py-[34px] relative max-sm:space-y-5">
      ...
      <div className="ml-4 md:ml-[36vw] xl:space-y-8 md:space-y-6 space-y-4">
        <div className="flex justify-center">
          {[...Array(3)].map((_, idx) => (
            <article
              key={idx}
              className="flex flex-col md:flex-row items-center gap-x-6 gap-y-4 md:gap-y-0 md:gap-x-8 xl:gap-x-10"
            >
              <div className="relative overflow-hidden rounded-lg">
                ...
                <div className="aspect-w-3 aspect-h-2">
                  <Image
                    fill
                    className="object-cover w-full h-full"
                    src="https://cms.junglebosstours.com/assets/a49ec0ec-5ea8-4507-a035-5d5a086b4c8f?format=webp"
              ...
              <div className="space-y-2">
                <div className="space-y-4">
                  <h3 className="text-text-500 title-1 line-clamp-1">Team Building 1D</h3>
                  <div className="space-y-1 text-gray-700 body-1">
                    <div>Level 2 - Easy to Moderate</div>
                    <div className="flex items-center justify-between space-x-3">
                      <div>1 day</div>
                      <div>10-15 pax/team</div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-1 text-primary">
                    ...
                    <div className="label-2 tracking-[0.28px] flex-1">
                      Trạ Ang Valley, Trạ Ang Cave
                    </div>
                  </div>
                </div>
                <hr className="w-full h-px bg-gray-100" />
                <div className="text-gray-700 body-1 line-clamp-5">
                  This tour is rated as medium level for those who are healthy and familiar with
                  outdoor activities as well as having little experience exploring adventures. 10km
                  hiking on relatively steep terrain, 600m swimming in the cave.
                </div>
              </div>
            </article>
          ))}
        ...
        <div className="flex items-center space-x-8 mr-custom max-lg:hidden">
          <div className="flex space-x-2">
            <button className="btn-slider selectNavPrev">
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="17"
            ...
            <button className="btn-slider selectNavNext">
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="17"
          ...
          <div className="relative flex-grow swiper-scrollbar">
            <div className="w-full h-[1px] bg-gray-200 absolute top-1/2"></div>
          </div>
          <div className="swiper-pagination headline-3 flex-shrink-0 w-[100px]"></div>
        </div>
      </div>
    </section>
  );
