...
const HeaderComponent = () => {
  ...
  return (
    <div>
      <header>
        <div className={`fixed top-0 left-0 z-[1000] flex items-center w-full duration-700 ease-in-out header-wrapper h-[70px] lg:h-24 ${isScrolled ? 'bg-[#34430f] shadow-lg backdrop-blur-sm' : 'max-lg:bg-[#34430f]'}`}>
            ...
            <div className="container">
              <div className="flex items-center justify-between w-full">
                    ...
                    <div className="relative w-full">
                      ...
                      <div className={`absolute flex items-center justify-center w-full mx-auto duration-1000 ease-in-out -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 ${isScrolled ? 'scale-100 opacity-100' : 'scale-0 opacity-0'}`}>
                        <picture>
                          ...
                          <img
                            className="xl:max-w-[265px] md:max-w-[186px] max-w-[170px]"
                ...
                <div className="flex items-center justify-between space-x-[22px]">
                  <div className="cursor-pointer text-[#eef4b7]">
                  ...
                  <div className="relative languages">
                    <div className="items-center hidden space-x-2 cursor-pointer md:flex">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="10" viewBox="0 0 16 10" fill="none">
                        <path d="M14.5739 0.920555C10.0879...Z" fill="#FCFFDF" />
                      </svg>
                    </div>
        ...
        {/* Overlay */}
        <div className="-translate-x-full fixed top-[70px] z-[51] w-screen h-[calc(100vh-70px)] overflow-hidden duration-500 ease-in-out bg-white">
