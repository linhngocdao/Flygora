                ...
                >
                    ...
                    <div className="container space-y-4">
                        ...
                        <div className="prose team-building-tour">
                            ...
                            <p>
                                Embrace a one-of-a-kind adventure with us – a promise to not only fortify your team's
                                ...
                                leaving an enduring mark on your team's collective journey. There are different team building
                    ...
                    <div className="w-max lg:h-[330px] md:h-[200px] h-[120px] flex gap-x-4" id="needToMove">
                        {[
                            ...
                            <div
                                key={index}
                                className={`lg:w-[400px] md:w-[300px] lg:h-[266px] md:h-[150px] w-[175px] h-[95px] rounded-[8px] overflow-hidden ${
                                    index % 2 !== 0 ? "self-end" : ""
                                }`}
                            >
                                <picture>
