      ...
      <section ref={sectionRef} className="relative overflow-hidden section-animation">
        <div className="absolute inset-0">
          <Image
            ...
            priority
            objectFit="cover"
            sizes="(max-width: 767px) 100vw, (max-width: 1439px) 100vw, 1920px"
          />
        </div>
        <div className="relative xl:py-[68px] md:py-[48px] py-[34px]">
          <div className="container">
            <div className="grid grid-cols-12 xl:gap-x-8 md:gap-x-6 gap-y-5">
              <div className="space-y-3 lg:col-span-6 lg:col-start-2 xl:space-y-4 col-span-full">
                ...
                <div className="text-gray-700 body-1 prose-overview">
                  <p>
                    ...
                    conventional team building landscape in Vietnam. Escape the mundane and seize
                    the extraordinary as your team engages in missions that demand collaboration,
                    creativity, and camaraderie. Our jungle setting serves as the ultimate canvas
                    for fostering teamwork, creating an atmosphere that is not only thrilling but
                    also indelibly unforgettable.
                  </p>
                  <p>
                    ...
                    extraordinary experience. At Jungle Boss, we redefine team building, making it
                    an immersive and thrilling escapade that transcends the ordinary, leaving an
                    enduring mark on your team&apos;s collective journey.There are different team
                    building options from 1 day to multiple days. Leave us a request and we can help
                    you tailor a unique Jungle Team building that suits your needs!&nbsp;&nbsp;
                  </p>
                </div>
              </div>
              <div className="md:col-span-6 md:col-start-4 lg:col-span-4 col-span-full">
          ...
          <div className="grid grid-cols-12 xl:gap-x-8 md:gap-x-6 gap-y-5">
            ...
            <div className="space-y-4 col-span-full lg:col-span-9 xl:space-y-8 md:space-y-6">
              <div className="grid gap-4 md:grid-cols-2 xl:gap-8 md:gap-5 gap-y-5">
                <div className="space-y-1 duration-300 ease-in-out md:space-y-2 xl:p-6 md:p-3 lg:hover:bg-[#fcffdf]">
          ...
          <div className="grid grid-cols-12 md:gap-x-6 xl:gap-x-8 gap-y-5">
            <div className="col-span-full md:col-span-5">
              <div className="overflow-hidden rounded-lg aspect-w-1 aspect-h-1">
                <Image fill src="/images/teamBuilding/connect-us.webp" alt="team working" />
              </div>
            </div>
